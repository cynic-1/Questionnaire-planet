<template>
  ...
  <q-drawer show-if-above side="left" bordered>
    <!-- drawer content -->
   <div class="left-main">
	  <q-btn-dropdown color="pink" label="个人信息" dropdown-icon="change_history" size="20px">
	    <q-list>
     ...
     <q-btn-dropdown color="pink" label="选择题" dropdown-icon="change_history" size="20px" style="margin-top: 40px;">
       <q-list>
